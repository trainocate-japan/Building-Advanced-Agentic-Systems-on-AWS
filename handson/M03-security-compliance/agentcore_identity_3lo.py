...
def main():
    ...
    print("  │ 🔐 ユーザーの同意確認                                          │")
    print("  │                                                                  │")
    print("  │ 本番環境ではユーザーが Hosted UI でログイン＆スコープに同意     │")
    print("  │ します。このデモでは「ユーザーが同意した」ことを想定して        │")
    print("  │ 認証 API を呼び出します。                                       │")
    print("  │                                                                  │")
    print("  │ スコープ: openid, profile, email                                │")
    print("  └────────────────────────────────────────────────────────────────┘")
    print()
    consent = input("  ユーザーとして同意しますか？ (y/N): ")
    if consent.lower() != "y":
        print()
        print("  ❌ ユーザーが同意を拒否しました。フローを中断します。")
        print("     → 3LO ではユーザーの明示的な同意が必須です。")
        return
    print()
    print("  ✅ ユーザーが同意しました。認証を続行します...")
